        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-slate-600 mt-1">
              Fully client-side simulator of EPR–Bell correlations. Toggle models, set analyzer
              angles, and see the CHSH value S update in real time.
            </p>
          </div>
                ...
                <TabsContent value="presets" className="pt-3">
                  <div className="grid gap-2">
                    ...
                    <div className="text-xs text-slate-500 mt-1">
                      “Quantum-optimal” maximizes |S| in the quantum model.
                    </div>
                  </div>
                </TabsContent>
                <TabsContent value="about" className="pt-3">
                  <div className="text-sm text-slate-600 leading-relaxed flex items-start gap-2">
                    ...
                    <div className="space-y-2">
                      <p>
                        Alice and Bob each choose between two analyzer orientations (a,a′ for Alice; b,b′
                        for Bob). The simulator computes four correlations E(a,b), E(a,b′), E(a′,b),
                        E(a′,b′) and combines them into the CHSH value S.
                      </p>
                      <p>
                        The “Quantum” model uses the singlet prediction E(θ)=−cosθ. The “Classical” model
                        uses E(θ)=1−2θ/π, which never exceeds |S|=2. Quantum correlations can reach
                        |S|=2√2.
                      </p>
                      <p className="text-xs">
                        Tip: the 3D analyzers and slider labels share colors with the CHSH sample points
                        below.
                      </p>
                    </div>
                  </div>
              ...
              <div className="grid gap-4">
                ...
                <motion.div
                  className={`rounded-2xl p-4 border ${
                    violation ? "bg-emerald-50 border-emerald-200" : "bg-slate-50 border-slate-200"
                  }`}
                ...
                >
                  ...
                  <div className="mt-1 flex items-end gap-3">
                    ...
                    <div
                      className={`text-sm ${
                        violation ? "text-emerald-600" : "text-slate-500"
                      }`}
                    >
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <Button
                    variant="ghost"
                    onClick={() =>
                      setAngles({ a: 0, aP: 45, b: 22.5, bP: 67.5 })
                    }
                  >
                    Reset
                  </Button>
